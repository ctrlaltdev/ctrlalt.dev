...
const MainHead = ({ title }) => (
    <Head>
        ...
        <meta property="og:image" content="https://ctrlalt.dev/static/social.png" />
        <meta property="og:url" content="https://ctrlalt.dev/" />
        <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no" />
        <meta name="theme-color" content="#222222" />
        <link rel="manifest" href="https://ctrlalt.dev/static/manifest.json" />
        <link rel="shortcut icon" href="https://ctrlalt.dev/static/favicon.png" />
